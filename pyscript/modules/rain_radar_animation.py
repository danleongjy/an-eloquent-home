@service
def rain_radar_animation(ms_per_frame = 500, basemap_file = '/config/www/rain_radar_basemap.jpg', input_folder = '/config/www/rain_radar', output_folder = '/config/www'):
    """
...
#        basemap_text.text((0,0), frame.filename[23:31] + ' at ' + frame.filename[31:35], fill = (255,255,255))
    ...
    overlaid_frames[0].save(output_folder + '/rain_radar_animation_' + frames[-1].filename[35:47] + '.gif', format = 'GIF', append_images = overlaid_frames, save_all = True, duration = 200, loop = 0)
