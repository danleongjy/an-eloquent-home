def rain_radar_animation(ms_per_frame = 500, basemap_file = '/config/www/rain_radar/rain_radar_basemap.jpg', input_folder = '/config/www/rain_radar/frames', output_folder = '/config/www/rain_radar'):
    ...
    frames = [Image.open(input_folder + '/' + frame) for frame in sorted(os.listdir(input_folder))[-92:]]
    overlaid_frames = []
    for frame in frames:
        ...
        basemap_text.rectangle([(395,470),(480,480)], fill = (0,0,0))
        basemap_text.text((395,470), frame.filename[42:50] + ' at ' + frame.filename[50:54], fill = (255,255,255))
