@service
def compile_rain_radar_animation(ms_per_frame = 500, basemap_file = '/config/www/rain_radar_basemap.jpg', input_folder = '/config/www/rain_radar', output_folder = '/config/www'):
    '''
